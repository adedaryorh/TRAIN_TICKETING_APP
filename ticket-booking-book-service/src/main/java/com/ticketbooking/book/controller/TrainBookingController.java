...
public class TrainBookingController {
	...
	@PostMapping("/train")
	public ResponseEntity<CommonApiResponse> bookTrain(@RequestBody
														   BookTrainRequestDto bookingRequest
	) {
		return trainBookingResource.bookTrain(bookingRequest);
	}
	
	@PostMapping("/add/scheduled/train/tickets/")
	public ResponseEntity<CommonApiResponse> addScheduledTrainTickets(@RequestBody
																		  AddScheduleTrainTicketRequestDto ticketAddRequest
	) {
		return trainBookingResource.addScheduledTrainTickets(ticketAddRequest);
	}
	
	@DeleteMapping("/ticket/cancel")
	public ResponseEntity<CommonApiResponse> cancelTrainTicket(
