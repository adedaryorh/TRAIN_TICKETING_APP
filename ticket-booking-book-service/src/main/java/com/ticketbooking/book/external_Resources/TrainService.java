package com.ticketbooking.book.external_Resources;
...
public interface TrainService {
	...
	ScheduleTrainResponseDto fetchScheduledTrainById(
	...
	public ResponseEntity<TrainDetailResponseDto> fetchTrainDetailsFromAndToLocation(
			@RequestParam("fromLocationId") int fromLocationId,
			@RequestParam("toLocationId") int toLocationId);
