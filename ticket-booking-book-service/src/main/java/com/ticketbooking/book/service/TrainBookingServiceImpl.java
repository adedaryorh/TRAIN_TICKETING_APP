...
public class TrainBookingServiceImpl implements TrainBookingService {
	...
	public List<TrainBooking> getByScheduleTrainIdAndStatus(int scheduleTrainId, int status) {
		// TODO Auto-generated method stub
		return trainBookingDao.findByScheduleTrainIdAndStatusOrderByIdDesc(
				scheduleTrainId,
				status);
	}
	...
	@Override
	public List<TrainBooking> getByBookingTimeBetweenAndUserId(String startDate,
															   String endDate,
															   int userId) {
		// TODO Auto-generated method stub
		return trainBookingDao.findByBookingTimeBetweenAndUserIdOrderByIdDesc(
				startDate,
				endDate,
				userId);
	}
